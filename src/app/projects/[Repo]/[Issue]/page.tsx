        ...
        <div className='flex'>
            ...
            <Topbar/>
                ...
                <div className="mt-20 mx-auto w-[calc(100%_-_16rem)] justify-center">
                    <form onSubmit={handleSubmit} className="max-w-[600px] border-2 dark:border-custom-dark-neutral rounded-xl p-10 mx-auto space-y-4">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full p-2 border-2 dark:border-custom-dark-neutral rounded-md h-32"
                required
              />
            </div>
