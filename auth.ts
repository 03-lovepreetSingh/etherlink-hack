...
export const { handlers, auth, signIn, signOut } = NextAuth({
  secret:
    process.env.AUTH_SECRET || "your-auth-secret-key-at-least-32-chars-long",
  providers: [
    GitHub({
      ...
      authorization: {
        params: {
          scope:
            "read:user user:email repo admin:repo_hook write:issues write:pull_requests read:pull_requests",
        },
      },
    }),
  ],
