        ...
        <div className="  hidden md:block">
          <div
            className={`dark:bg-neutral-950 z-[950] bg-neutral-50
             border-b-1 fixed top-0 px-5 py-2 border-b-[1px] border-custom-neutral dark:border-custom-dark-neutral ${
               isShrunk ? "w-[calc(100%_-_4rem)]" : "w-[calc(100%_-_16rem)]"
                      ...
                      <div>
                        ...
                        <div className="pt-3">
                          ...
                          <Link href="/PullRequests">
                            <div className="rounded-lg gap-2 text-sm focus:bg-neutral-400 hover:bg-neutral-100 dark:hover:bg-[#27272a] px-2 py-2 flex">
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="16"
                                height="16"
